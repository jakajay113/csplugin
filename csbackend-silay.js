                                ...
                                jsonData.data.ChatSpecificInformation.forEach(chat => {      
                                    ...
                                    // Determine the file display based on file type
                                            if (chat.file_type === "image/jpeg" || chat.file_type === "image/png") {
                                                ...
                                                : `<img src="https://eservices.bagocity.gov.ph/spidc_web_api/CSPluginServer${chat.file_path}" alt="Attachment" onclick="viewFullScreen('https://eservices.bagocity.gov.ph/spidc_web_api/CSPluginServer${chat.file_path}')" style="cursor: pointer;">`;
