                                ...
                                jsonData.data.ChatSpecificInformation.forEach(chat => {      
                                    ...
                                    // Determine the file display based on file type
                                            if (chat.file_type === "image/jpeg" || chat.file_type === "image/png") {
                                                ...
                                                : `<img src="https://eservices.bagocity.gov.ph/spidc_web_api_test/CSPluginServer${chat.file_path}" alt="Attachment" onclick="viewFullScreen('https://eservices.bagocity.gov.ph/spidc_web_api_test/CSPluginServer${chat.file_path}')" style="cursor: pointer;">`;
                                                ...
                                                if(messageClass =="sender"){
                                                    filevalueData = chat.file_path === "Message Unsend" ? chat.file_path 
                                                    : `<a href="https://eservices.bagocity.gov.ph/spidc_web_api_test/CSPluginServer${chat.file_path}" download="${chat.file_path.split('/').pop()}" style="color: #000;">${chat.file_path.split('/').pop()}</a>`;
                                                   // filevalueData = `<a href="https://eservices.bagocity.gov.ph/spidc_web_api_test/CSPluginServer${chat.file_path}" download="${chat.file_path.split('/').pop()}" style="color: #000;">${chat.file_path.split('/').pop()}</a>`;
                                                }else{
                                                    filevalueData = chat.file_path === "Message Unsend" ? chat.file_path 
                                                    : `<a href="https://eservices.bagocity.gov.ph/spidc_web_api_test/CSPluginServer${chat.file_path}" download="${chat.file_path.split('/').pop()}" style="color: #fff;">${chat.file_path.split('/').pop()}</a>`;
                                                    //filevalueData = `<a href="https://eservices.bagocity.gov.ph/spidc_web_api_test/CSPluginServer${chat.file_path}" download="${chat.file_path.split('/').pop()}" style="color: #fff;">${chat.file_path.split('/').pop()}</a>`;
                                                }
